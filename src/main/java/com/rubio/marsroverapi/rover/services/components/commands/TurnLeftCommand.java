...
/**
 * Implementación de {@link RoverCommand} que representa el comando para rotar a la izquierda.
 * <p>
...
public class TurnLeftCommand implements RoverCommand{
    ...
    /**
     * Ejecuta el comando de rotar a la izquierda sobre el rover recibido.
     * <p>
